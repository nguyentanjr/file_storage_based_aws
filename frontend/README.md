...
- Node.js 16+ and npm
- Backend server running on http://13.212.106.138
...
The application will open at http://localhost:3000 (local dev) or http://13.212.106.138 (production)
...
- **Base URL**: http://13.212.106.138
- **Authentication**: Session cookies (withCredentials: true)
- **CORS**: Enabled for http://13.212.106.138
...
### CORS Issues
Make sure backend has CORS enabled for http://13.212.106.138
